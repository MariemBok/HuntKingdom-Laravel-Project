                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="user-photo m-b-30">
                          <img class="img-fluid" src="{{url('backOffice/images/user-profile.jpg')}}" alt="" />
                        </div>
                        <div class="user-work">
                          <h4>work</h4>
              ...
              <div class="card">
                ...
                <div class="recent-comment">
                  ...
                  <div class="media">
                    <div class="media-left">
                      <a href="#">
                        <img class="media-object" src="{{url('backOffice/images/avatar/2.jpg')}}" alt="...">
                      </a>
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media no-border">
                    <div class="media-left">
                      <a href="#">
                        <img class="media-object" src="{{url('backOffice/images/avatar/3.jpg')}}" alt="...">
                      </a>
                    </div>
                    <div class="media-body">
                      <h4 class="media-heading">Mr. John</h4>
